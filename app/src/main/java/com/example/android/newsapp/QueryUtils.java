    ...
    private static List<NewsItem> extractFeatureFromJson(String newsItemJSON) {
        ...
        try {
            ...
            for (int i = 0; i < NewsItemArray.length(); i++) {
                ...
                // Create a new {@link NewsLink} object with the section, article title,
                // publication date, author and url from the JSON response.

                NewsItem newsItem = new NewsItem(sectionName, webPublicationDate,
                        webTitle, webUrl);
